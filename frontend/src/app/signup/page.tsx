        ...
        <div className="px-7 py-5">
          ...
          {step === 1 && (
            <div className="animate-in fade-in slide-in-from-right-4 duration-300">
              ...
              <p className="text-slate-500 mb-4 text-xs">
                Let&apos;s set up your personal profile first.
              </p>
              ...
              >
                <div className="space-y-1">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="flex h-9 w-full rounded-md border border-slate-300 bg-white px-3 py-2 pl-9 text-sm placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-violet-500"
                    />
                  </div>
                </div>
                <div className="space-y-1">
                ...
                <button
                  type="submit"
                  className="w-full flex items-center justify-center gap-2 bg-slate-900 text-white hover:bg-slate-800 transition-colors h-9 px-4 py-2 rounded-md font-medium text-sm mt-2"
                >
          ...
          {step === 2 && (
            <div className="animate-in fade-in slide-in-from-right-4 duration-300">
              ...
              <p className="text-slate-500 mb-4 text-xs">
                How do you plan to use Posture OS?
              </p>
              ...
              <div className="space-y-2">
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-500">
                      Set up a tenant for your company.
                    </p>
                  </div>
                </button>
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-500">
                      Enter an invite code to join your company tenant.
                    </p>
                  </div>
                </button>
              </div>
              ...
              <button
                onClick={() => setStep(1)}
                className="w-full text-center text-xs text-slate-500 font-medium hover:text-slate-800 mt-4"
              >
                &larr; Back
              </button>
            </div>
              ...
              <form className="space-y-3" onSubmit={handleSignup}>
                ...
                <div className="bg-violet-50 border border-violet-100 p-3 rounded-lg">
                  <p className="text-xs text-violet-800 font-medium text-center">
                    Automated self-service registration is currently restricted.
                    Submit a request to provision your enterprise node.
                  </p>
                </div>
            ...
            <div className="animate-in fade-in slide-in-from-right-4 duration-300">
              ...
              <form className="space-y-3" onSubmit={handleSignup}>
                    ...
                    <div className="flex w-full items-center justify-between">
                      <div>
                        <p className="font-semibold text-slate-900 text-sm flex items-center gap-2">
                          Annual{" "}
                          <span className="bg-violet-100 text-violet-700 text-[9px] uppercase font-bold px-2 py-0.5 rounded-full">
                            Save 58%
                          </span>
                        </p>
                        <p className="text-xs text-slate-500">
                          7 days free, then $5/yr
                        </p>
                      </div>
                      <p className="text-base font-bold text-slate-900">
                        $5
                ...
                <button
                  disabled={loading || !turnstileToken}
                  type="submit"
                  className="w-full flex items-center justify-center gap-2 bg-slate-900 text-white hover:bg-slate-800 transition-colors h-9 px-4 py-2 rounded-md font-medium text-sm"
                >
              ...
              <button
                onClick={() => setStep(2)}
                className="w-full text-center text-xs text-slate-500 font-medium hover:text-slate-800 mt-3"
              >
                &larr; Back
              </button>
            </div>
          ...
          {step === 4 && (
            <div className="animate-in fade-in zoom-in duration-300 text-center py-2">
              ...
              <p className="text-slate-500 mb-6 text-sm">
                We&apos;ve received your request to set up{" "}
                <strong>{orgName}</strong>. Our team will provision your
                enterprise node within 24 hours.
              </p>
              <Link
                href="/login"
                className="inline-flex items-center justify-center gap-2 bg-slate-900 text-white hover:bg-slate-800 transition-colors h-9 px-6 py-2 rounded-md font-medium text-sm"
              >
                Return to Login
              </Link>
            </div>
          ...
          {step === 5 && (
            <div className="animate-in fade-in zoom-in duration-300 text-center py-2">
              ...
              <p className="text-slate-500 mb-6 text-sm">{successMessage}</p>
              <Link
                href="/login"
                className="inline-flex items-center justify-center gap-2 bg-slate-900 text-white hover:bg-slate-800 transition-colors h-9 px-6 py-2 rounded-md font-medium text-sm"
              >
